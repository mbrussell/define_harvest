...
tree_live <- tree %>% 
  ...
  mutate(tpa_part = TPA_UNADJ,
         tpa_part_5 = ifelse(DIA.y >= 5.0, TPA_UNADJ, 0),
         ba_part = (0.00545415*DIA.y^2)*TPA_UNADJ,
         ba_part_5 = ifelse(DIA.y >= 5.0, (0.00545415*DIA.y^2)*TPA_UNADJ, 0),
         RD_part = ifelse(DIA.y >= 5.0,
                          ((0.00015+(0.00218*WOOD_SPGR_MC12VOL_DRYWT))*
                             (DIA.y*2.54/10)**1.6)*2.4701, 0))
